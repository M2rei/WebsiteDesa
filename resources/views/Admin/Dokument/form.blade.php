...
@section('title', 'Tambah Dokumen - Sistem Informasi Desa')
@section('page-title', 'Tambah Dokumen Baru')

@section('content')
    <form action="{{ route('admin.dokumen-desa.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <input type="text" id="nama_document" name="nama_document" value="{{ old('nama_document') }}"
            ...
            <!-- Placeholder Fields (Hanya untuk kategori: Surat) -->
            <div id="field-container-wrapper" class="hidden">
                ...
                <div id="field-container" class="space-y-2">
                    <div class="flex items-center gap-2">
                        <input type="text" name="fields[]" class="w-full px-4 py-2 border rounded-lg"
            ...
            <!-- Upload Dokumen -->
            <div>
                <label class="block text-lg font-semibold text-gray-700 mb-2">Upload File Dokumen (.docx, .pdf)</label>
                <div class="upload-area border-2 border-dashed border-blue-400 rounded-lg p-12 text-center bg-blue-50 hover:bg-blue-100 cursor-pointer"
                    ...
                    <p class="text-gray-700 font-medium mb-2">Klik di sini untuk memilih file dokumen</p>
                    <p class="text-gray-500 text-sm">Format: DOCX, PDF. Maksimum 2MB</p>
                    <input type="file" id="dokumen-input" name="dokumen" accept=".docx, .pdf" class="hidden">
